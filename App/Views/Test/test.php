...
<body>
	<form>
		<label><input type="checkbox" name="user-type" value="customer" checked> Customer</label>
		<label><input type="checkbox" name="user-type" value="admin" id="admin-checkbox"> Admin</label>
		<label><input type="text" name="admin-key" placeholder="Admin Secret Key" id="admin-key-field"></label>
...
$(document).ready(function() {
	$("#signin-form").submit(function(event) {
		...
		var adminKey = $("#admin-key-field").val();

		// perform AJAX request with form data
		$.ajax({
			url: "signin.php", // replace with your PHP script URL
			type: "POST",
			data: { userType: userType, adminKey: adminKey },
