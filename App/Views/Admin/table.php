            ...
            <div class="new_food_wrapper_edit">
                <form class="table_form" class="form" name="food-form">
                    ...
                    <div class="input_wrapper">
                        ...
                        <input class="food_name" autofocus type="text" >
                    </div>
                    ...
                    <div class="input_wrapper">
                        <input class="submit_btn" type="submit" value="Edit details" >
                    </div>
            ...
            <nav class="nav bd-container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="" class="nav__link">Jack Maaye</a></li>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>A ghanaian delicacy</td>
                            <td>15</td>
                            <td>GHC 20.00</td>
                            <td><i class='bx bx-edit' id="mySizeChart"></i></td>
