      ...
      <div class="nav__menu" id="nav-menu">
        ...
        if (isset($_SESSION['user_id'])) {
          ...
          echo '
            ...
            <li class="nav__item">
            <i id ="cart-btn" class="bx bx-cart-alt cart__button" style="" ></i>
          </li>
          <div class="avartar">
      ...
      <div class="contact__container bd-grid">
        <div class="contact__data">
          ...
          <p class="contact__description">
            ...
            For any queries, please contact us.<br />Feel free to contact and
            suggest the improvements that are required for this website
          </p>
        </div>
  ...
  <footer class="footer section bd-container">
    <div class="footer__container bd-grid">
      ...
      <div class="footer__content">
        ...
        <ul>
          <li>
            <a href="table.html" class="footer__link">Table Reservation</a>
          </li>
